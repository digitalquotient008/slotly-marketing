...
export const metadata = {
  title: 'About - MeetEasy',
  description: 'Learn about MeetEasy and our mission to simplify scheduling.',
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-600 mb-6 text-lg">
              MeetEasy was born from a simple idea: scheduling meetings shouldn&apos;t require multiple tools, 
            ...
            <p className="text-gray-600 mb-6 text-lg">
              Unlike other scheduling platforms, MeetEasy includes essential features like contact management 
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6 mt-12">Open & Transparent</h2>
            <p className="text-gray-600 mb-6 text-lg">
              MeetEasy is open-source and can be self-hosted. You own your data and have full control 
